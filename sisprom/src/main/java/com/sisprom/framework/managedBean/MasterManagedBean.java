...
public String redireccionar(){	
	    ...
	    Secretaria secre= new Secretaria(1,"sole", "camus", "Los ceibos","32234242","1232345","usuario1","pass1",audi,null,null); 
	    //services.saveSecretaria(secre);
	    
	    Medico medi= new Medico(1, "Mariana", "Alcon", "dir1", "tel1", "dni1", "usuario2", "pass2", audi, "matricula1", "especialidad1", null, null);
	   // services.updateMedico(medi);
	    
	    Paciente pac= new Paciente(1, "Jenifer", "kenvinson", "dir23", "tel23", "dni23", audi, "obraSocial1", "23");
	    //services.deletePaciente(pac);
	    
	    Turno turn= new Turno(2, null, null, audi, pac,secre);
	    //services.deleteTurno(turn);
	    
	    TipoAntecedente tipoAnt= new TipoAntecedente(2, "TipoA2", "descripcion2X", audi);
	    //services.saveTipoAntecedente(tipoAnt);
	    
	    
	    HistoriaClinica histC= new HistoriaClinica(1, "descripHC3x", audi, pac, medi);
	   //services.saveHistoriaClinica(histC);
	    ...
	    Medicamento medito = new Medicamento(2, "NomMedito2x", "Desc42", audi);
	    ...
	    Tratamiento trata = new Tratamiento(2, "Trata2x", "descr52", audi);
